...
function drawListToDOM() {
    ...
    var _loop_1 = function (index_1) {
         ...
         */
        todo.innerHTML = "<span class='check " + array1[index_1].todosChecked + "'><i class='fas fa-check'></i></span>"
            + array1[index_1].todosText +
...
function updateCounter() {
    var done = 0;
    var undone = 0;
    for (var index_2 = 0; index_2 < array1.length; index_2++) {
        if (array1[index_2].todosChecked == true) {
            done++;
        }
        else {
            undone++;
    ...
    counterDOMElement.innerHTML = array1.length + " in total " + done + " done " + undone + " undone ";
}
/**
...
function toggleCheckState(index) {
     ...
     */
    array1[index].todosChecked = !array1[index].todosChecked;
    /**
     * Die zentrale Funktion, um die Liste des ToDo-Arrays in den DOM zu rendern
     * wird wieder getriggert
     */
